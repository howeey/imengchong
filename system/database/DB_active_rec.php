...
class CI_DB_active_record extends CI_DB_driver {
	...
	function insert_sql($table = '', $set = NULL)
	{
		if ( ! is_null($set))
		{
			$this->set($set);
	...
	public function update_sql($table = '', $set = NULL, $where = NULL, $limit = NULL)
	{
		// Combine any cached components with the current statements
		$this->_merge_cache();
    ...
    public function delete_sql($table = '', $where = '', $limit = NULL, $reset_data = TRUE)
	{
		// Combine any cached components with the current statements
		$this->_merge_cache();
